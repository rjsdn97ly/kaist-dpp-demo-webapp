import { c as create_ssr_component, b as compute_rest_props, a as setContext, d as spread, e as escape_object, f as escape_attribute_value, g as add_attribute, i as is_void, n as noop, v as validate_component } from "../../chunks/index.js";
...
const Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="header-div" style="display: flex; flex-direction: column; box-shadow: 0px 0px 5px 1px #555555;">${validate_component(Navbar, "Navbar").$$render($$result, { color: "form" }, {}, {
      ...
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<img${add_attribute("src", logo, 0)} class="mt-1 mr-2 h-4" alt="Logo">
            <span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white">KAIST GS1 DIGITAL LINK
            </span>`;
        }
      })}
        `;
